...
class GarbageReceiptScreen extends StatefulWidget {
  final List eachGarbageItem;
  const GarbageReceiptScreen({Key? key, required this.eachGarbageItem})
      : super(key: key);

  @override
  State<GarbageReceiptScreen> createState() => _GarbageReceiptScreenState();
}

class _GarbageReceiptScreenState extends State<GarbageReceiptScreen> {
  @override
  Widget build(BuildContext context) {
    ...
    final List prices = [50, 30, 10, 40, 50, 30];
                  ...
                  Container(
                    ...
                    child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int index) {
                          total +=
                              widget.eachGarbageItem[index] * prices[index];
                          return Container(
                            ...
                            child: ListTile(
                              ...
                              title: Text('${garbageType[index]}',
                                  style: TT.f18w600
                                      .copyWith(color: Color(0xff669902))),
                              trailing: Text('${widget.eachGarbageItem[index]}',
                                  style: TT.f18w600
                                      .copyWith(color: Color(0xff669902))),
                            ),
                          );
